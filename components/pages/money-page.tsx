  ...
  return (
    <div className="flex flex-col w-full h-full overflow-y-auto">
      ...
      <div className="grid grid-cols-2 gap-2 px-3 pb-4">
        {/* Savings */}
        <div className="bg-white rounded-[14px] p-3 flex flex-col cursor-pointer">
          <div className="flex justify-between items-start mb-1">
            <span className="text-xs font-semibold text-[#111111]">Savings</span>
            <span className="text-xs text-[#C7C7CC]">❯</span>
          </div>
          <div className="w-10 h-10 rounded-full bg-[#C8E6C9] flex items-center justify-center text-[#2E7D32] mb-2">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              <circle cx="12" cy="12" r="10" />
              <line x1="12" y1="6" x2="12" y2="18" stroke="white" strokeWidth="2" strokeLinecap="round" />
            </svg>
          </div>
          <div className="text-base font-bold text-[#111111]">$0.00</div>
        ...
        <div className="bg-white rounded-[14px] p-3 flex flex-col cursor-pointer">
          ...
          <div className="w-10 h-10 rounded-lg bg-[#E3F2FD] flex items-center justify-center mb-2">
            <div className="text-xl font-bold text-[#1976D2]">₿</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[14px] p-3 flex flex-col cursor-pointer">
          ...
          <div className="w-10 h-10 rounded-lg bg-[#F3E5F5] flex items-center justify-center mb-2">
        ...
        <div className="bg-white rounded-[14px] p-3 flex flex-col cursor-pointer">
          ...
          <div className="w-10 h-10 rounded-lg bg-[#FFF9C4] flex items-center justify-center mb-2">
